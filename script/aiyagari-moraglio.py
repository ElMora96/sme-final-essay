...
import os
#################################
#CLASS NEEDED TO SOLVE THE MODEL#
#################################
...
#######################################
#EXAMPLE OF SOLUTION TO AIYAGARI MODEL#
#######################################

#(1) - Find optimal accumulation policy
...
plt.title("Optimal accumulation policy")

#Plot optimal acccumulation policy at fixed prices
plt.show()
...
plt.title("Aiyagari Equilibrium")
plt.show()